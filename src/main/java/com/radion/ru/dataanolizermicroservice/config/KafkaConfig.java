package com.radion.ru.dataanolizermicroservice.config;
...
public class KafkaConfig {
    ...
    public ReceiverOptions<String, Object> receiverOptions(){
        ReceiverOptions<String, Object> receiverOptions = ReceiverOptions.create(
                receiverProperties()
        );
        return receiverOptions.subscription(topics)
                .addAssignListener((partrition) -> System.out.println("assigned: " + partrition))
                .addRevokeListener((partrition) -> System.out.println("revoke: " + partrition));
    }
